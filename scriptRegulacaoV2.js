function fClausula(pScript, pCondicional) {
    ...
    for (let wIdx = 0; wIdx < wMClausulas.length; wIdx++) {
        ...
        var wItemSave = wJsonScriptRegulacao["" + wScript + ""]["" + wScriptItem + ""] || {};

        wRetornoClausula += ` '${_cc.string.valor(wItemSave["anResposta"])}' ${wOperador} ${wValor2} `;
...
function fMontaScript(wItem, pBoDesc) {
                ...
                <div class="cc-inp  cc-col cc-col-${wColspan}" style="">
                    <div class="form-group position-relative">
                        <div  >
                            ...
                            <input data-script-omt='${wScriptItem.cnRegulacaoScript}' data-interacao-requerido='${wScriptItem.boRequerido}' data-interacao-tp='${wScriptItem.cnInteracaoTP}' data-script-omt-item='${wScriptItem.csRegulacaoScriptItem}' class="form-control" placeholder="">
                        </div>
                    </div>
                </div>
                    ...
                    wHtml += `
                            ...
                            <div class="cc-inp  cc-col cc-col-${wColspan}" style="">
                                <div class="form-group position-relative">
                                    ...
                                    <input data-interacao-requerido='${wScriptItem.boRequerido}' data-script-omt='${wScriptItem.cnRegulacaoScript}' data-interacao-tp='${wScriptItem.cnInteracaoTP}'  data-script-omt-item='${wScriptItem.csRegulacaoScriptItem}' class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" anResposta="${wMOptions[wIdx]}"/>
    ...
    if (wJsonScriptRegulacao["" + wScriptItem.cnRegulacaoScript + ""]["" + wScriptItem.csRegulacaoScriptItem + ""]) {
        ...
        if (wInteracaoValor) {
            ...
            (wInteracaoHtm.attr("data-interacao-tp") == '11') ? $(`[data-script-omt='${wScriptItem.cnRegulacaoScript}'][data-script-omt-item='${wScriptItem.csRegulacaoScriptItem}'][anResposta='${wInteracaoValor}']`).attr('checked', true) : wInteracaoHtm.val(wInteracaoValor);
        }
    }
...
$(document).on(cc.evento.click, "[data-script-btn-anterior='true']", async function () {
    try {
        ...
        (wInteracaoHtm.attr("data-interacao-tp") == '11') ? $(`[data-script-omt='${wScriptCodigo}'][data-script-omt-item='${wScriptItem}'][anResposta='${wInteracaoValor}']`).attr('checked', true) : wInteracaoHtm.val(wInteracaoValor);
